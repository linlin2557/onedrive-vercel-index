...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'cloud@thesstaroverthesky.onmicrosoft.com',
  ...
  title: "Union Earth Grovement's database",
  ...
  email: 'mailto:StarLin050324@outlook.com',
